...
epsilon = 1e-6
onnxFile = "./decoderV2.onnx"
onnxSurgeonFile = "./decoderV2-surgeon.onnx"
...
profile.set_shape(inputTensor[0].name, [1,16,256], [16,64,256], [64,256,256])
profile.set_shape(inputTensor[1].name, [1,], [16,], [64,])
profile.set_shape(inputTensor[2].name, [1,10,64], [16,10,64], [64,10,64])
profile.set_shape(inputTensor[3].name, [1,10,], [16,10,], [64,10,])
profile.set_shape(inputTensor[4].name, [1,10,], [16,10,], [64,10,])
